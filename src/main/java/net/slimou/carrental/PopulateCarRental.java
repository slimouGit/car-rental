...
import net.slimou.carrental.clientele.AccountRepository;
import net.slimou.carrental.clientele.Customer;
import net.slimou.carrental.clientele.CustomerRepository;
import net.slimou.carrental.company.*;
import net.slimou.carrental.contactinformation.Adress;
import net.slimou.carrental.contactinformation.AdressRepository;
import net.slimou.carrental.contactinformation.Communication;
import net.slimou.carrental.contactinformation.CommunicationRepository;
import net.slimou.carrental.reservation.Drive;
import net.slimou.carrental.reservation.DriveRepository;
...
import net.slimou.carrental.reservation.InvoiceRepository;
import net.slimou.carrental.reservation.Reservation;
import net.slimou.carrental.reservation.ReservationRepository;
import net.slimou.carrental.human.Person;
import net.slimou.carrental.human.PersonRepository;
import net.slimou.carrental.human.Person_Data;
import net.slimou.carrental.human.Person_DataRepository;
import net.slimou.carrental.staff.Employee;
import net.slimou.carrental.staff.EmployeeRepository;
import net.slimou.carrental.staff.OrderBook;
import net.slimou.carrental.staff.OrderBookRepository;
